...
public class FenetreAccueil extends JFrame implements ActionListener {
    ...
    public FenetreAccueil() {
        ...
        String[] tab  = ControleurCatalogue.demandeListeCatalogue();
        modifierListesCatalogues(tab);
        String[] tab2 = ControleurCatalogue.demandeListeCatalogueAvecNbProduits();
        modifierDetailCatalogues(tab2);
        modifierNbCatalogues(tab2.length);
        setVisible(true);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btAjouter)
        {
            ...
            {
                if(ControleurCatalogue.ajouterCatalogue(texteAjout)){
                    txtAjouter.setText(null);
                    modifierListesCatalogues(ControleurCatalogue.demandeListeCatalogue());
                    String[] tab2 = ControleurCatalogue.demandeListeCatalogueAvecNbProduits();
                    modifierDetailCatalogues(tab2);
                    modifierNbCatalogues(tab2.length);
                }
        ...
        if (e.getSource() == btSelectionner)
        {
            ...
            {
                ControleurCatalogue.selectectionnerCatalogue(texteSelection);
